...
| mg-platform-kernel | Java 平台内核、唯一应用注册目录、网关与服务治理 |
...
桌面与相关服务部署记录见 `mg-desktop-one/deploy/`。本次包含公共壳返回桌面、应用版本展示、Office 中文字体安装支持及 Token 桌面嵌入空白修复。最新服务治理版本为 `20260909T025742Z`：基本及组合请求/响应兼容推导、差异字段定位和发布保护已上线，69 项桌面测试、类型检查、服务管理构建及隔离 HTTP 发布测试通过。
