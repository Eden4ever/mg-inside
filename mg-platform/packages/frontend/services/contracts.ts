...
export interface ServiceManifest { schemaVersion: 1; serviceId: string; appId: string; name: string; version: string; description: string; operations: ServiceOperation[]; exposure?: 'gateway'|'catalog'; }
